...
\affil{$^{2}$Institut de Ciències de l'Espai (ICE, CSIC), Can Magrans,
...
\begin{figure}
\begin{centering}
\includegraphics[angle=270,scale=0.45]{orkl\lyxdot cnt\lyxdot uncorr}
\par\end{centering}
\begin{centering}
\includegraphics[angle=270,scale=0.45]{orkl\lyxdot cnt\lyxdot corr}
\par\end{centering}
...
\vspace{-1cm}
\begin{centering}
\includegraphics[scale=0.35]{OrionKL\lyxdot map\lyxdot spec\lyxdot co3-2peakv}\includegraphics[scale=0.37,angle=270,origin=c]{orkl_080106\lyxdot co3-2\lyxdot full\lyxdot plane3}
\par\end{centering}
\begin{centering}
\includegraphics[scale=0.35]{IRC+10216\lyxdot map\lyxdot spec\lyxdot co3-2peakv}\includegraphics[angle=270,origin=c,scale=0.37]{irc+10216\lyxdot co3-2\lyxdot full\lyxdot plane7}
\par\end{centering}
...
\vspace{-1cm}
\begin{centering}
\includegraphics[scale=0.35]{NGC7538\lyxdot map\lyxdot spec\lyxdot co3-2peakv\lyxdot notfull}\includegraphics[scale=0.37,angle=270,origin=c]{NGC7538S-s4\lyxdot co3-2\lyxdot full\lyxdot plane38}
\par\end{centering}
\begin{centering}
\includegraphics[scale=0.35]{IRAS2a\lyxdot map\lyxdot spec\lyxdot co3-2peakv}\includegraphics[angle=270,origin=c,scale=0.37]{iras2a\lyxdot aver\lyxdot co3-2}
\par\end{centering}
...
\vspace{-0.5cm}
\begin{centering}
\includegraphics[bb=20bp 40bp 565bp 780bp,clip,width=0.8\paperwidth]{stokesv\lyxdot map\lyxdot spec\lyxdot co3-2peakv}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics[bb=50bp 0bp 740bp 612bp,clip,scale=0.37]{OrionKL\lyxdot map\lyxdot spec\lyxdot sio8-7peakv}
\par\end{centering}
